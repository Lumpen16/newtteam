...
export default class ProductCards extends React.Component<{}, {food: boolean}> {
        ...
        return (
            ...
            <div className="product_cards">
                <div className="product_cards_pointers">
                    ...
                    <FoodCard name="first" classy={this.state.food ? "product_cards_first previous-first" : "product_cards_first next-first"}/>
                    <CustomCard classy={this.state.food ? "previous-second" : "next-second"}/>
